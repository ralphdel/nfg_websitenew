...
function normalizeMedia(media, fallbackMedia) {
  ...
  return {
    ...
    videoMuted: media?.videoMuted ?? fallbackMedia?.videoMuted ?? true,
    videoLoop: media?.videoLoop ?? fallbackMedia?.videoLoop ?? true,
    videoPlaysInline: media?.videoPlaysInline ?? fallbackMedia?.videoPlaysInline ?? true,
