    ...
    <section className="section" id="leadership">
      <div className="container">
        <SectionHeader
          ...
          body="A short homepage view of the people leading NFG's manufacturing, operational and technical transformation."
        />
        ...
        <div className="center-action">
          <Button href="#contact" variant="secondary" icon={Users}>Meet the Leadership Team</Button>
        </div>
      </div>
    </section>
  );
